...
-- ANSWER :- 
--  Adams Andrew is that one person who is the senior most employee based on job title .
...
-- ANSWER :- 
-- USA has the most invoices (131 invoices)
...
-- ANSWER :- here are the top 3 rows according to total invoice 
...
-- ANSWER :- 
-- prague has the highest total , so it is the best city according to sum of total
...
-- ANSWER :- FrantiAiek WichterlovAi is one the best customer accroding to the total spent money 


-- MODERATE LEVEL QUESTIONS :-
-- QUESTION 6 :- write a query to return the email, first name, last name, & Genre of all ROck Musci listeners. Return your list ordered alphabetically by email starting with A.
...
-- QUESTION 3 :- Return all the track names that have a song length longer than the average song length. Return the Name and Milliseconnds for each track. Order by the song length with the longest songs listed first. 
